...
{ path: 'pedidobodunif', component: PedidobodunifComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'repuestos','repuestoslv','repuestoslk','repuestoslsc','laboratorio1','laboratorio2'] } },
  ...
  { path: 'laboratoriorev', component: LaboratoriorevComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'repuestos', 'laboratorio','laboratorio1','laboratorio2','laboratorio3', 'bodegaimpor','repuestoslv','repuestoslk','repuestoslsc'] } },
