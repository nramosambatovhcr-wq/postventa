...
import { BlModel, BlService, InvoiceBlModel } from 'src/app/services/bl.service';
import { CotizacionService } from 'src/app/services/cotizacion.service';
import { PedidobodegaService } from 'src/app/services/pedidobodega.service';
import { ReloadService } from 'src/app/services/reload.service';

@Component({
  selector: 'app-bl-invoice',
  templateUrl: './bl-invoice.component.html',
  styleUrls: ['./bl-invoice.component.css']
})
export class BlInvoiceComponent implements OnInit, OnDestroy {
