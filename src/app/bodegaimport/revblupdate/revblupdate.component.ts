...
@Component({
  selector: 'app-revblupdate',
  templateUrl: './revblupdate.component.html',
  styleUrls: ['./revblupdate.component.css']
})
export class RevblupdateComponent implements OnInit, OnDestroy {
  ...
  etapas = [
    ...
    {
      nombre: 'FECHA LIQUIDACIÓN',
      descripcion: 'Fecha de liquidación de la importación',
      campo: 'fliquidacion',
      bloqueado: false
    }
  ];
