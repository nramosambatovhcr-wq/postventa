...
@Component({
  selector: 'app-detallescot',
  templateUrl: './detallescot.component.html',
  styleUrls: ['./detallescot.component.css']
})
export class DetallescotComponent implements OnInit, OnDestroy  {
  stats = {
