...
@Component({
  selector: 'app-revisioncot',
  templateUrl: './revisioncot.component.html',
  styleUrls: ['./revisioncot.component.css']
})
export class RevisioncotComponent implements OnInit, OnDestroy  {
  stats = {
...
closeImageModal(): void {
  ...
  loadimportaciones() {
    this.loading = true;
    this.tutorialService.getCotizacionDetail(this.codigoCot).subscribe({
      next: (data: any) => {
