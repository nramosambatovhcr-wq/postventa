...
@Component({
  selector: 'app-blvhcrdetail',
  templateUrl: './blvhcrdetail.component.html',
  styleUrls: ['./blvhcrdetail.component.css']
})
export class BlvhcrdetailComponent implements OnInit, OnDestroy {
