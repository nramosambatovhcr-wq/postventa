...
export class ObservacionesComponent implements OnInit, OnChanges, AfterViewChecked {
  ...
  private baseImageUrl = 'https://bodega.vehicentro.com:1830/api/api/Pedidos/Observaciones/imagen/';
  ...
  cargarObservaciones(): void {
    ...
    this.pedidoService.getObservacionesPedido(this.pedido.id_pedido).subscribe({
      next: (data: any) => {
  ...
  enviarObservacion(): void {
    ...
    this.pedidoService.addObservacion(formData).subscribe({
      next: (response) => {
