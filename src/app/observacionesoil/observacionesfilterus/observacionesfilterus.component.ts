...
@Component({
  selector: 'app-observacionesfilterus',
  templateUrl: './observacionesfilterus.component.html',
  styleUrls: ['./observacionesfilterus.component.css']
})
export class ObservacionesfilterusComponent implements OnInit, OnChanges, AfterViewChecked {
