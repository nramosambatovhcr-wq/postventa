...
@Component({
  selector: 'app-observacionesinsumos',
  templateUrl: './observacionesinsumos.component.html',
  styleUrls: ['./observacionesinsumos.component.css']
})
export class ObservacionesinsumosComponent implements OnInit, OnChanges, AfterViewChecked {
