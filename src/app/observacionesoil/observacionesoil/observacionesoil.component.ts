...
@Component({
  selector: 'app-observacionesoil',
  templateUrl: './observacionesoil.component.html',
  styleUrls: ['./observacionesoil.component.css']
})
export class ObservacionesoilComponent implements OnInit, OnChanges, AfterViewChecked {
