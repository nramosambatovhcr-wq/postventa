...
@Component({
  selector: 'app-pedidosbod',
  templateUrl: './pedidosbod.component.html',
  styleUrls: ['./pedidosbod.component.css']
})
export class PedidosbodComponent implements OnInit, OnDestroy  {
  stats = {
