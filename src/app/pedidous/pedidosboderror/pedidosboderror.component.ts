...
@Component({
  selector: 'app-pedidosboderror',
  templateUrl: './pedidosboderror.component.html',
  styleUrls: ['./pedidosboderror.component.css']
})
export class PedidosboderrorComponent implements OnInit, OnDestroy  {
  stats = {
...
closeImageModal(): void {
  ...
  loadimportaciones() {
    this.loading = true;
    this.tutorialService.errorped(this.id).subscribe({
      next: (data: any) => {
