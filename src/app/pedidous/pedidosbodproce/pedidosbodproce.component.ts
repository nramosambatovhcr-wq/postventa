...
@Component({
  selector: 'app-pedidosbodproce',
  templateUrl: './pedidosbodproce.component.html',
  styleUrls: ['./pedidosbodproce.component.css']
})
export class PedidosbodproceComponent implements OnInit, OnDestroy  {
  stats = {
  ...
  loadimportaciones() {
    this.loading = true;
    this.tutorialService.procesop(this.id).subscribe({
      next: (data: any[]) => {
