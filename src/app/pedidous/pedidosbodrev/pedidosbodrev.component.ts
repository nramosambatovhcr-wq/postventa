...
@Component({
  selector: 'app-pedidosbodrev',
  templateUrl: './pedidosbodrev.component.html',
  styleUrls: ['./pedidosbodrev.component.css']
})
export class PedidosbodrevComponent implements OnInit, OnDestroy  {
  stats = {
  ...
  loadimportaciones() {
    this.loading = true;
    this.tutorialService.revisadop(this.id).subscribe({
      next: (data: any) => {
