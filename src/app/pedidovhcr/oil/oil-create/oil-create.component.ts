...
@Component({
  selector: 'app-oil-create',
  templateUrl: './oil-create.component.html',
  styleUrls: ['./oil-create.component.css']
})
export class OilCreateComponent implements OnInit {
  oilForm: FormGroup;
  ...
  presentaciones: string[] = ['litro', 'galon', 'caneca', 'tanque'];
  ...
  onSubmit(): void {
    ...
    selectedPresentaciones.forEach(presentation => {
      ...
      apiCalls.push(this.oilService.createOil(oilData));
    });
