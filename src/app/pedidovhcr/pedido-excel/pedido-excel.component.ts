...
@Component({
  selector: 'app-pedido-excel',
  templateUrl: './pedido-excel.component.html',
  styleUrls: ['./pedido-excel.component.css']
})
export class PedidoExcelComponent implements OnInit {
