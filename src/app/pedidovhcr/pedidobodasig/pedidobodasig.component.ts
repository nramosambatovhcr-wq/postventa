...
@Component({
  selector: 'app-pedidobodasig',
  templateUrl: './pedidobodasig.component.html',
  styleUrls: ['./pedidobodasig.component.css']
})
export class PedidobodasigComponent implements OnInit, OnDestroy  {
  stats = {
