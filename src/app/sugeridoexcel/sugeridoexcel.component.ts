...
@Component({
  selector: 'app-sugeridoexcel',
  templateUrl: './sugeridoexcel.component.html',
  styleUrls: ['./sugeridoexcel.component.css']
})
export class SugeridoexcelComponent implements OnInit, OnDestroy {
  ...
  async uploadData(): Promise<void> {
    ...
    try {
      const response = await this.pedidobodegaService.uploadExcelSu(formData).pipe(first()).toPromise()!;
