...
@Component({
  selector: 'app-sugeridosadrev',
  templateUrl: './sugeridosadrev.component.html',
  styleUrls: ['./sugeridosadrev.component.css']
})
export class SugeridosadrevComponent implements OnInit, OnDestroy  {
  stats = {
